...
import { changeChart } from "@/app/GlobalRedux/Features/CurrencySlice/currencySlice";
...
const Home = () => {
  ...
  const {currency: currentCurrency, currentChart } = useAppSelector((state) => state.currency)
  ...
  return (
    <div className="">
      ...
      <div className="flex w-full justify-around items-center p-4">
        <div><ChartSelector coins={coins} currentChart={currentChart} currentCurrency={currentCurrency} handleChartSelection={handleChartSelection}/></div>
